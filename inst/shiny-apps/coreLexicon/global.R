...
broken_window=tibble::tibble(target = c("a","and","ball","be","boy","break","go","he","in",
...
cat_rescue=tibble::tibble(target =c("a","and","bark","be","call","cat","climb","come","department", 'dad',
                    "dog","down","father","fire","get","girl","go","have","he",
                    "in","ladder","little","tree","not","up", 'out', 'with', 'she', 'fireman',
                    'so', 'stick', 'the', 'their', 'there', 'to'))

cinderella = tibble::tibble(target =c('a', 'after', 'all', 'and', 'as', 'at', 'away', 'back','ball',
...
sandwich = tibble::tibble(target =c("a","and","bread","butter","get","it","jelly","knife","of", 'on',
